...
QT_MOC_LITERAL(5, 31, 16), // "setSelectedPiece"
QT_MOC_LITERAL(6, 48, 18) // "clearSelectedPiece"

    },
    "BoardWidget\0squareClicked\0\0x\0y\0"
    "setSelectedPiece\0clearSelectedPiece"
};
...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->squareClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->setSelectedPiece((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->clearSelectedPiece(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BoardWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BoardWidget::squareClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BoardWidget::squareClicked(int _t1, int _t2)
{
